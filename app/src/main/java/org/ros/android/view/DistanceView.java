...
public class DistanceView extends GLSurfaceView implements OnTouchListener, NodeMain,
   ...
   * {@link Renderer} and is used to render the distance view.
   */
  ...
  public void onStart(ConnectedNode connectedNode) {
    ...
    Subscriber<LaserScan> laserScanSubscriber =
        connectedNode.newSubscriber(laserTopic, LaserScan._TYPE);
